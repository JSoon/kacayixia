...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dailyPhoto = __webpack_require__(189);

	var _dailyPhoto2 = _interopRequireDefault(_dailyPhoto);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var rootReducers = (0, _redux.combineReducers)({
	    dailyPhoto: _dailyPhoto2.default
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dailyPhoto = function dailyPhoto() {
	    ...
	    switch (action.type) {
	        case _constants2.default.RECEIVE_DAILYPHOTO:
...
/***/ function(module, exports) {
	...
	// 每日瞬间图片及摄影师详情
	var FETCH_DAILYPHOTO = 'FETCH_DAILYPHOTO';
	var RECEIVE_DAILYPHOTO = 'RECEIVE_DAILYPHOTO';

	exports.default = {
	    FETCH_DAILYPHOTO: FETCH_DAILYPHOTO,
	    RECEIVE_DAILYPHOTO: RECEIVE_DAILYPHOTO
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Moments = __webpack_require__(264);
	...
	var routes = _react2.default.createElement(
	    ...
	    _react2.default.createElement(_reactRouter.Route, { path: '/moments', component: _Moments2.default })
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dailyPhoto = __webpack_require__(258);
	...
	var Home = function (_Component) {
	    ...
	    _createClass(Home, [{
	        ...
	        value: function componentWillMount() {
	            ...
	            dispatch((0, _dailyPhoto.fetchDailyPhoto)());
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            var photographer = _props.photographer;

	            return _react2.default.createElement(
	                'div',
	                { className: 'home-tree' },
	                _react2.default.createElement('img', { className: 'photo-of-today', src: photo.url, title: photo.title, alt: photo.title }),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'upper' },
	                    _react2.default.createElement('i', { className: 'logo sj sj-logo' }),
	                    _react2.default.createElement(
	                        'h5',
	                        { className: 'slogan' },
	                        '一瞬间，便是永恒。'
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'a',
	                        { className: 'avatar', href: photographer.url },
	                        _react2.default.createElement('img', { src: photographer.avatar, title: photographer.name, alt: photographer.name })
	                    ),
	                    _react2.default.createElement(
	                        'h5',
	                        { className: 'username' },
	...
	Home.propTypes = {
	    photo: _react.PropTypes.shape({
	        url: _react.PropTypes.string,
	        title: _react.PropTypes.string
	    }).isRequired,
	    photographer: _react.PropTypes.shape({
	        url: _react.PropTypes.string,
	...
	function mapStateToProps(state) {
	    var _state$dailyPhoto = state.dailyPhoto;
	    var photo = _state$dailyPhoto.photo;
	    var photographer = _state$dailyPhoto.photographer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.receiveDailyPhoto = exports.fetchDailyPhoto = undefined;
	...
	function fetchDailyPhoto() {
	    return function (dispatch) {
	        return $.ajax('data/dailyPhoto.json').done(function (json) {
	            return dispatch(receiveDailyPhoto(json));
	        }).fail(function (err) {
	...
	function receiveDailyPhoto(json) {
	    return {
	        type: _constants2.default.RECEIVE_DAILYPHOTO,
	        json: json,
	        receivedAt: Date.now()
	    };
	}

	exports.fetchDailyPhoto = fetchDailyPhoto;
	exports.receiveDailyPhoto = receiveDailyPhoto;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".home-tree:after {\n  position: fixed;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  display: block;\n  z-index: 0;\n  background: linear-gradient(rgba(90, 85, 78, 0.45) 0%, rgba(100, 94, 85, 0.45) 20%, rgba(36, 43, 39, 0.55) 100%);\n  content: \"\";\n}\n.home-tree .photo-of-today {\n  z-index: 0;\n  position: fixed;\n  top: -100%;\n  left: -100%;\n  bottom: -100%;\n  right: -100%;\n  width: 100%;\n  min-width: 100%;\n  margin: auto;\n  animation: photoOfToday 8s ease-in-out;\n}\n@keyframes photoOfToday {\n  from {\n    width: 180%;\n  }\n  to {\n    width: 100%;\n  }\n}\n.home-tree .upper {\n  position: absolute;\n  top: 15%;\n  left: 0;\n  z-index: 2;\n  width: 100%;\n  text-align: center;\n}\n.home-tree .upper .logo {\n  font-size: 11em;\n  line-height: 1;\n  color: #fff;\n  opacity: .8;\n}\n.home-tree .upper .slogan {\n  margin: 30px 0;\n  color: rgba(255, 255, 255, 0.95);\n  font-size: 14px;\n  line-height: 1;\n}\n.home-tree .upper .browse {\n  display: inline-block;\n  padding: 13px 88px;\n  color: rgba(255, 255, 255, 0.95);\n  font-size: 16px;\n  border: 1px solid rgba(255, 255, 255, 0.6);\n  border-radius: 40px;\n}\n.home-tree .upper .browse:hover,\n.home-tree .upper .browse:focus {\n  border-color: rgba(0, 0, 0, 0.8);\n  background: rgba(0, 0, 0, 0.8);\n  text-decoration: none;\n}\n.home-tree .lower {\n  position: absolute;\n  bottom: 10%;\n  left: 0;\n  z-index: 1;\n  width: 100%;\n  text-align: center;\n}\n.home-tree .lower .caption {\n  margin: 0;\n  color: rgba(255, 255, 255, 0.9);\n  font-size: 12px;\n}\n.home-tree .lower .avatar img {\n  width: 96px;\n  height: 96px;\n  margin: 10px 0;\n  border: 4px solid rgba(255, 255, 255, 0.2);\n  border-radius: 50%;\n  opacity: .8;\n}\n.home-tree .lower .avatar:hover img,\n.home-tree .lower .avatar:focus img {\n  opacity: 1;\n}\n.home-tree .lower .username {\n  margin: 0;\n}\n.home-tree .lower .username a {\n  color: rgba(255, 255, 255, 0.7);\n}\n.home-tree .lower .username a:hover,\n.home-tree .lower .username a:focus {\n  color: #fff;\n  text-decoration: underline;\n}\n.home-tree footer.root {\n  position: fixed;\n  bottom: 0;\n  left: 0;\n  z-index: 1;\n  width: 100%;\n  color: rgba(255, 255, 255, 0.6);\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Moments = function (_Component) {
	    _inherits(Moments, _Component);

	    function Moments() {
	        _classCallCheck(this, Moments);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Moments).apply(this, arguments));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/less-loader/index.js!./Moments.less", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/less-loader/index.js!./Moments.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".moments-list figure,\n.moment-details figure.photo-preview {\n  margin: 0 0 20px;\n}\n.moments-list figure .photo,\n.moment-details figure.photo-preview .photo {\n  position: relative;\n}\n.moments-list figure .photo .photo-over,\n.moment-details figure.photo-preview .photo .photo-over {\n  position: absolute;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  line-height: 1;\n  background-color: transparent;\n  opacity: 0;\n}\n.moments-list figure .photo .photo-over .sj,\n.moment-details figure.photo-preview .photo .photo-over .sj {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  margin-top: -0.5em;\n  margin-left: -0.5em;\n  color: #fff;\n  font-size: 2.571em;\n}\n.moments-list figure .photo:hover .photo-over,\n.moment-details figure.photo-preview .photo:hover .photo-over,\n.moments-list figure .photo:focus .photo-over,\n.moment-details figure.photo-preview .photo:focus .photo-over {\n  opacity: 1;\n  background-color: rgba(255, 255, 255, 0.35);\n}\n.moments-list figure figcaption,\n.moment-details figure.photo-preview figcaption {\n  height: 40px;\n  margin-top: 8px;\n  line-height: 40px;\n}\n.moments-list figure figcaption .avatar,\n.moment-details figure.photo-preview figcaption .avatar {\n  float: left;\n}\n.moments-list figure figcaption .avatar img,\n.moment-details figure.photo-preview figcaption .avatar img {\n  width: 40px;\n  height: 40px;\n  margin-right: 10px;\n  border-radius: 50%;\n}\n.moments-list figure figcaption .like,\n.moment-details figure.photo-preview figcaption .like {\n  float: right;\n  text-decoration: none;\n}\n.moments-list figure figcaption .sj,\n.moment-details figure.photo-preview figcaption .sj {\n  font-size: 18px;\n}\n.moments-list figure figcaption .sj-heart-o,\n.moment-details figure.photo-preview figcaption .sj-heart-o {\n  color: #bbbbbb;\n}\n.moments-list figure figcaption .sj-heart-o:hover,\n.moment-details figure.photo-preview figcaption .sj-heart-o:hover {\n  color: #FF5736;\n}\n.moments-list figure figcaption .sj-heart,\n.moment-details figure.photo-preview figcaption .sj-heart {\n  color: #FF5736;\n}\n.moments-list figure .photo-link {\n  position: relative;\n  display: block;\n  height: 266px;\n  overflow: hidden;\n}\n.moments-list figure .photo-link img {\n  position: absolute;\n  top: 0;\n  left: 0;\n  bottom: 0;\n  right: 0;\n  width: 100%;\n  height: auto;\n  margin: auto;\n}\n.moments-list figure.top-pick .photo-link {\n  height: 600px;\n}\n.moment-details figure.photo-preview {\n  margin-bottom: 40px;\n}\n.moment-details figure.photo-preview .photo-over {\n  cursor: zoom-in;\n}\n.moment-details .breadcrumb {\n  line-height: 2;\n  margin-bottom: 10px;\n}\n.moment-details .breadcrumb .sj {\n  margin-right: 5px;\n  font-size: 14px;\n}\n.moment-details .photo-info .description {\n  border-bottom: 1px solid #eeeeee;\n}\n.moment-details .photo-info .description .title {\n  margin-top: 0;\n  margin-bottom: 15px;\n}\n.moment-details .photo-info .description .sj {\n  margin-right: 5px;\n  font-size: 20px;\n}\n.moment-details .photo-info .description p {\n  margin-bottom: 15px;\n  line-height: 1.6em;\n}\n.moment-details .photo-info ul {\n  list-style: none;\n  margin: 0;\n  padding: 0;\n}\n.moment-details .photo-info ul.info {\n  margin-bottom: 15px;\n  padding: 15px 0;\n  line-height: 2.5;\n  border-bottom: 1px solid #eeeeee;\n}\n.moment-details .photo-info ul.info span.k {\n  display: inline-block;\n  width: 3em;\n  margin-right: 1em;\n  color: #bbbbbb;\n}\n.moment-details .photo-info ul.price li {\n  margin-bottom: 15px;\n  overflow: hidden;\n}\n.moment-details .photo-info .dl-btn span {\n  float: left;\n  display: inline-block;\n  height: 50px;\n  line-height: 48px;\n  border: 1px solid #ddd;\n}\n.moment-details .photo-info .dl-btn:hover,\n.moment-details .photo-info .dl-btn:focus {\n  cursor: pointer;\n}\n.moment-details .photo-info .dl-btn:hover span,\n.moment-details .photo-info .dl-btn:focus span {\n  color: #fff;\n  border-color: transparent;\n  background: rgba(0, 0, 0, 0.8);\n}\n.moment-details .photo-info .dl-btn .sj {\n  font-size: 14px;\n  margin-right: 5px;\n}\n.moment-details .photo-info .dl-btn .k {\n  padding-left: 2.5em;\n  padding-right: 2em;\n  border-right: none;\n  border-radius: 40px 0 0 40px;\n}\n.moment-details .photo-info .dl-btn .v {\n  padding-left: 2em;\n  padding-right: 2.5em;\n  color: #fff;\n  border-color: rgba(0, 0, 0, 0.8);\n  background: rgba(0, 0, 0, 0.8);\n  border-radius: 0 40px 40px 0;\n}\n.moment-details .photo-info .dl-btn em {\n  color: #bbbbbb;\n  font-style: normal;\n  vertical-align: middle;\n}\n.moment-details .comments .title {\n  padding-bottom: 15px;\n  border-bottom: 1px solid #eeeeee;\n}\n.moment-details .comments .title .sj {\n  font-size: 20px;\n}\n.moment-details .comments .title span {\n  margin: 0 5px;\n  color: #bbbbbb;\n}\n.moment-details .comments .media-object {\n  border-radius: 50%;\n}\n.moment-details .comments .sj-reply {\n  margin-left: 5px;\n}\n.moment-details .comments .comment-reply {\n  display: none;\n}\n.moment-details .comments .comment-reply .form-group input[type=\"text\"] {\n  padding: .5em .7em;\n}\n.moment-details .comments .comment-reply .form-group .btn {\n  padding: .5em;\n}\n", ""]);
